...
export default class MyMessage extends Component {
    ...
    componentWillMount() {
        ...
        if (numberValue !== '' && numberValue !== null)
            this.setState({ numberValue, showHighLight: true })
            ...
            <View className='MyMessage'>
                ...
                <View className='MyMessage_body_content'>
                    <View className='MyMessage_content_type_wrap'>
                        ...
                        <AtInput type='text' value={nameValue}  className='MyMessage_content_input' placeholder='请输入您的姓名' maxLength='7' onChange={(value) => this.getNameValue(value)} 

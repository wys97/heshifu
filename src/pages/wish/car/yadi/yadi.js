...
export default class Yadi extends Component {
    ...
    componentDidMount() {
        ...
        window.onresize = function () {
            if (document.body.scrollHeight < h)
                document.getElementsByClassName("Yadi_btn_submit_wrap")[0].style.display = "none";
            else {
        ...
        return (
            <View className='Yadi'>
                ...
                <View className='Yadi_content_wrap'>
                    ...
                    <AtInput className='' value={name} type='text' placeholder='请输入真实姓名' maxLength='7'
                        onBlur={this.onInputBlur.bind(this)} onChange={this.setNameValue.bind(this)} />

                    <View className='Yadi_type_title'>手机</View>
                    <Input className='Yadi_input' value={phoneNumber} type='number' maxLength='11' placeholder='请输入手机号码'

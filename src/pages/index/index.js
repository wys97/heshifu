...
export default class Index extends Component {
  ...
  componentWillMount() {
    ...
    if (enterType != 0)
      this.setState({ enterType: enterType });
    ...
    Taro.getSystemInfo({
      success: res => { localStorage.setItem('systemInfo', JSON.stringify(res)) }
    });
        ...
        JSWX.ready(function () {
          ...
          JSWX.getLocation({
            ...
            success: function (res1) {
              ...
              Netservice.request({
                url: 'heque-eat/eat/get_city_code_and_city',
                method: 'GET',
                data:{
                ...
                success: res2 => {
                  ...
                  if ((enterType == 1 && cityCode.length < 2) || (enterType == 0))
                    that.setState({ cityCode: cityCode1, city: city1 });

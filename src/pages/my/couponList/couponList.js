                ...
                return <View className='couponList_wrap' key={index}>
                    <View className='couponList_title'>
                        <View className='flex_column coupon_priceList'>
                            ...
                            {item.useType === 1 ? "" :
                                <Text className='coupon_scope'>满<Text className='coupon_price_color'>{item.useType === 2 ? item.consumptionMoney : ''}</Text>元可用</Text>}
                        </View>
                    ...
                    <View className='coupon_shop_astrict'>{item.storeInfoName == null ?
                         <Text>不限门店</Text>: 
                         <Text>限 { item.storeName } 使用</Text>
                        }</View>
                </View>
            })
            }

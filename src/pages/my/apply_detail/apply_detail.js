...
export default class ApplyDetail extends Component {
  ...
  getInfo(type, rid) {
    ...
    let url = '';
    if (type == 0)
      url = 'heque-backend/collect/queryLoanDetail';
    else if (type == 1)
      url = 'heque-backend/work_driver/queryWorkDriverDetail';
    else if (type == 2)
      url = 'heque-backend/employ_driver/employDriverDetail';
    else if (type == 3)
      url = 'heque-backend/collectCarInfo/findDetail';
    else if (type == 4)
      url = 'heque-backend/collectYaDiInfo/findDetail';
    else if (type == 5)
      url = 'heque-backend/collectCaoCaoInfo/findDetail';
    else if (type == 6)
      url = 'heque-backend/collectShouQiInfo/findDetail';
    else if (type == 7)
      url = 'heque-backend/collectPreciseCarInfo/findDetail';
  ...
  render() {
    ...
    return (
      <View className='container-apply-detail'>
  ...
  getAmountStr(value) {
    const list = [{ value: 1, text: '1000 ~ 1万' },
    { value: 2, text: '1万 ~ 5万' },
    { value: 3, text: '5万以上' }];
  ...
  getPreferenceStr(value) {
    const list = [{ value: 1, text: '纯信用借款产品' },
  ...
  getRepaymentStr(value) {
    const list = [{ value: 1, text: '按日计息，随借随还' },
  ...
  getEarningStr(value) {
    const list = [{ value: 1, text: '5000~8000元' },
  ...
  getEmergencyStr(value) {
    const list = [{ value: 1, text: '越快越好，即刻需求' },
  ...
  //租车 ----------------
  getRentArray(value = '') {
    const list = [{ value: 1, text: '燃油车', more: '' },
    { value: 2, text: '新能源车', more: '' },
    { value: 3, text: '短租期', more: '(3个月)' },
    { value: 4, text: '租车跑快车', more: '(注重车辆性价比)' },
    { value: 5, text: '租车跑专车', more: '(注重车辆品牌性能)' }];
  ...
  getMonies(value) {
    let list = [{ value: 0, text: '不限' },
    { value: 1, text: '2000~4000元' },
    { value: 2, text: '4000~6000元' },
    { value: 3, text: '6000元以上' }];

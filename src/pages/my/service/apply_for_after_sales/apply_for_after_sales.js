...
export default class ApplyForAfterSales extends Component {
    config = {
    ...
    render() {
                ...
                <View className='reasonOption_contnet_list'>
                    {reasonList.map((item, index) => {
                        return <View className='reasonOption_list_message' key={index} onClick={this.reasonOptionContent.bind(that, item)}>
                            ...
                            {checkedId === item.id ? <Image className='reasonOption_icon' src={checked} style='pointer-events: none' /> :
                                <Image className='reasonOption_icon' src={checkedNo} style='pointer-events: none' />}
                        </View>
                    })
                    }
                </View>
        ...
        return (
            <View className='ApplyForAfterSales'>
                <View className='ApplyForAfterSales_content'>
                    ...
                    <View className='refund_reason_wrap'>
                        ...
                        <View className='refund_reason_replenish'>
                            <Textarea type='text' placeholder='补充详细信息以便客服更快帮您处理( 选填 ),最多140字'
                                maxLength='140'
                                className='refund_reason_input'
                                onBlur={this.getInputValue.bind(that)}
                            />
                        </View>
                    </View>
                </View>

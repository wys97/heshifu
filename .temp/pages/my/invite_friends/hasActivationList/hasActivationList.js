...
export default class HasActivationList extends Taro.Component {
  ...
  render() {
    ...
    return <View className="HasActivationList">
                {hasActivationListData.length === 0 ? <View className="noListData_style">

...
export default class AssistantDetails extends Taro.Component {
  ...
  componentWillMount() {
    ...
    if (numberValue !== '' && numberValue !== null) this.setState({ phoneNumber: numberValue, showHighLight: true });
  ...
  render() {
    ...
    return <View className="AssistantDetails">
                ...
                <View className="AssistantDetails_content_wrap">
                    ...
                    <AtInput className="AssistantDetails_type_input" value={nameValue} type="text" placeholder="请输入您的名字" maxLength="7" onBlur={this.onInputBlur.bind(this)} onChange={this.setNameValue.bind(this)} />

...
// 下单买单
export default class PointPackage extends Taro.Component {
  ...
  render() {
    ...
    return <View className="Order">
                ...
                </View> : <View className="Order_dishes_details">
    ...
    Netservice.request({
      ...
      success: function (res) {
        if (res.code == '300030') {
          ...
          let noDishes = false;
          if (packageList.length <= 0) noDishes = true;

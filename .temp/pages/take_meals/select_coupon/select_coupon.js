...
export default class SelectCoupon extends Taro.Component {
  ...
  componentWillMount() {
    ...
    if (orderId) this.getCoupons('heque-coupon/discount_coupon/queryIsUseCoupon', { orderId: orderId });else {
  ...
  render() {
    ...
    return <View className="container-coupons">
